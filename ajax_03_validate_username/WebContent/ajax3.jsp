...
<script>
	window.onload = function() {
		...
		useEle.onblur = function() { // 给按钮点击事件注册监听
			/*
				ajax四步操作，得到服务器的响应
				把响应结果显示到h1元素中
			 */
			...
			// 2.打开服务器连接
			xmlHttp.open("POST", "/ajax_01_hello/validateUsernameServlet", true);
			// 3.发送请求
			xmlHttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
			xmlHttp.send("username="+useEle.value);
			...
			xmlHttp.onreadystatechange = function() { // 当xmlHttp的状态发生变化时执行
				...
				if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
					...
					// 获取h1元素
					var h1 = document.getElementById("errorSpan");
					h1.innerText = text;
				}
			}
		}
